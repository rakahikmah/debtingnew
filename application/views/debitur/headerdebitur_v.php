      ...
      <ul class="nav navbar-nav navbar-right">
       <li class="<?php if($this->uri->segment(2)==""){echo "active";}?>"><a href="<?=site_url('debitur');?>"><span class="glyphicon glyphicon-home"></span> Home</a></li>
        ...
        <li class="dropdown">
          ...
          <?php else: ?>
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-user"></span><?=$this->session->userdata('nama')?>&nbsp;&nbsp;&nbsp;<span style="color:white; background: red;"></span> <span class="caret"></span></a> 
          <?php endif ?>
